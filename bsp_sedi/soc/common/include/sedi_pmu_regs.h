...
/*
 * Bit Field of Register ISH_MASK_EVENT
 *   MASK_TIMER_WK: HPET Timer Wake Mask 1-Mask Wake From Timer Event 0-No Mask For Wake From Timer
 *   Event
 *     BitOffset : 16
 *     BitWidth  : 1
 *     AccessType: RW
...
/*
 * Bit Field of Register ISH_MASK_EVENT
 *   MASK_SPI_WK: SPI0 Wake Interrupts 1-Mask Wake From SPI0 Event 0-No Mask For Wake From SPI0
 *   Event
 *     BitOffset : 22
 *     BitWidth  : 1
 *     AccessType: RW
 ...
 *     ResetValue: (uint32_t)0x2
 */
SEDI_RBF_DEFINE(PMU, RF_ROM_CLKGATE_TO_ISOEN_CTRL, CLKGATE_TO_ISOEN_COUNTER, 0, 16, RW,
		(uint32_t)0x2);
 ...
 *     ResetValue: (uint32_t)0x2
 */
SEDI_RBF_DEFINE(PMU, RF_ROM_ISOEN_TO_PWRGATE_CTRL, ISOEN_TO_PWRGATE_COUNTER, 0, 16, RW,
		(uint32_t)0x2);
 ...
 *     ResetValue: (uint32_t)0x2
 */
SEDI_RBF_DEFINE(PMU, RF_ROM_PWRUNGATE_TO_ISODIS_CTRL, PWRUNGATE_TO_ISODIS_COUNTER, 0, 16, RW,
		(uint32_t)0x2);
 ...
 *     ResetValue: (uint32_t)0x0
 */
SEDI_RBF_DEFINE(PMU, RF_ROM_PWRUNGATE_TO_ISODIS_CTRL, RSVD_PWRUNGATE_ISODIS, 16, 16, RO,
		(uint32_t)0x0);
 ...
 *     ResetValue: (uint32_t)0x2
 */
SEDI_RBF_DEFINE(PMU, RF_ROM_ISODIS_TO_CLKGATEEXIT_CTRL, ISODIS_TO_CLKGATEEXIT_COUNTER, 0, 16, RW,
		(uint32_t)0x2);
 ...
 *     ResetValue: (uint32_t)0x0
 */
SEDI_RBF_DEFINE(PMU, RF_ROM_ISODIS_TO_CLKGATEEXIT_CTRL, RSVD_ISODIS_CLKGATEEXIT, 16, 16, RO,
		(uint32_t)0x0);
 ...
 *   RF_ROM_POWER_GATING_ENABLE: RF And ROM Power Gating Enable 1-RF ROM Power Gating Enable 0-RF
 *   ROM Power Gating Disable
 *     BitOffset : 0
 *     BitWidth  : 1
 *     AccessType: RW
 *     ResetValue: (uint32_t)0x0
...
/*
 * Bit Field of Register RF_ROM_PWR_CTRL
 *   AONRF_DEEPSLEEP_EN: AON RF DeepsleepEnable 1-Enable AON_RF Deepsleep Mode 0-Disable AONRF
 *   Deepsleep Mode
 *     BitOffset : 1
 *     BitWidth  : 1
 *     AccessType: RW
 ...
 */
SEDI_RBF_DEFINE(PMU, SRAM_PWR_CTRL, SRAM_POWERGATE_TO_POWERUNGATE_COUNTER, 8, 4, RW,
		(uint32_t)0x0f);
...
/*
 * Bit Field of Register ISH_MASK_EVENT2
 *   MASK_SPI2_WK: SPI2 Wake Interrupts 1-Mask Wake From SPI2 Event 0-No Mask For Wake From SPI2
 *   Event
 *     BitOffset : 24
 *     BitWidth  : 1
 *     AccessType: RW
...
/*
 * Bit Field of Register ISH_MASK_EVENT2
 *   MASK_SPI3_WK: SPI3 Wake Interrupts 1-Mask Wake From SPI3 Event 0-No Mask For Wake From SPI3
 *   Event
 *     BitOffset : 25
 *     BitWidth  : 1
 *     AccessType: RW
...
/*
 * Bit Field of Register RESET_PREP_REG
 *   MASK_RESET_PREP_AVAIL: Prep Avail Mask 1- Mask Reset Prep Avail Interrupt 0-Reset Prep Avail
...
/*
 * Bit Field of Register CG_PG_STATUS_REG
 *   PGREADY_BRPRIM_ENTRY_STATUS: Successful PowerGate Ready Achieved For Bridge Primary Clock
 *   Domain
 *     BitOffset : 8
 *     BitWidth  : 1
 *     AccessType: RW_1C
 ...
 *     ResetValue: (uint32_t)0x0
 */
SEDI_RBF_DEFINE(PMU, CDCCLKREQCTLDIS_REG, CDC0_BRPRICLK_CLK_REQ_CTL_DIS_REG, 0, 1, RW,
		(uint32_t)0x0);
 ...
 *     ResetValue: (uint32_t)0x0
 */
SEDI_RBF_DEFINE(PMU, CDCCLKREQCTLDIS_REG, CDC1_BRSBCLK_CLK_REQ_CTL_DIS_REG, 1, 1, RW,
		(uint32_t)0x0);
 ...
 *     ResetValue: (uint32_t)0x0
 */
SEDI_RBF_DEFINE(PMU, CDCCLKREQCTLDIS_REG, CDC2_SBEPCLK_CLK_REQ_CTL_DIS_REG, 2, 1, RW,
		(uint32_t)0x0);
 ...
 *     ResetValue: (uint32_t)0x0
 */
SEDI_RBF_DEFINE(PMU, CDCCLKREQCTLDIS_REG, CDC3_FUNCCLK_CLK_REQ_CTL_DIS_REG, 3, 1, RW,
		(uint32_t)0x0);
 ...
 *     ResetValue: (uint32_t)0x0
 */
SEDI_RBF_DEFINE(PMU, CDCCLKREQCTLDIS_REG, CDC5_MIACCLK_CLK_REQ_CTL_DIS_REG, 4, 1, RW,
		(uint32_t)0x0);
 ...
 *     ResetValue: (uint32_t)0x0
 */
SEDI_RBF_DEFINE(PMU, CDCCLKREQCTLDIS_REG, CDC6_XTALCLK_CLK_REQ_CTL_DIS_REG, 5, 1, RW,
		(uint32_t)0x0);
 ...
 *     ResetValue: (uint32_t)0x0
 */
SEDI_RBF_DEFINE(PMU, CDCCLKREQOFFHOLDOFF_REG, CDC0_BRPRICLK_REQ_OFF_HOLD_OFF_REG, 0, 4, RW,
		(uint32_t)0x0);
 ...
 *     ResetValue: (uint32_t)0x0
 */
SEDI_RBF_DEFINE(PMU, CDCCLKREQOFFHOLDOFF_REG, CDC1_BRSBCLK_REQ_OFF_HOLD_OFF_REG, 4, 4, RW,
		(uint32_t)0x0);
 ...
 *     ResetValue: (uint32_t)0x0
 */
SEDI_RBF_DEFINE(PMU, CDCCLKREQOFFHOLDOFF_REG, CDC2_SBEPCLK_REQ_OFF_HOLD_OFF_REG, 8, 4, RW,
		(uint32_t)0x0);
 ...
 *     ResetValue: (uint32_t)0x0
 */
SEDI_RBF_DEFINE(PMU, CDCCLKREQOFFHOLDOFF_REG, CDC3_FUNCCLK_REQ_OFF_HOLD_OFF_REG, 12, 4, RW,
		(uint32_t)0x0);
 ...
 *     ResetValue: (uint32_t)0x0
 */
SEDI_RBF_DEFINE(PMU, CDCCLKREQOFFHOLDOFF_REG, CDC5_MIACCLK_REQ_OFF_HOLD_OFF_REG, 16, 4, RW,
		(uint32_t)0x0);
 ...
 *     ResetValue: (uint32_t)0x0
 */
SEDI_RBF_DEFINE(PMU, CDCCLKREQOFFHOLDOFF_REG, CDC6_XTALCLK_REQ_OFF_HOLD_OFF_REG, 20, 4, RW,
		(uint32_t)0x0);
 ...
 *     ResetValue: (uint32_t)0x0
 */
SEDI_RBF_DEFINE(PMU, CDCCLKREQSYNCOFFHOLDOFF_REG, CDC0_BRPRICLK_REQ_SYNCOFF_HOLD_OFF_REG, 0, 4, RW,
		(uint32_t)0x0);
 ...
 *     ResetValue: (uint32_t)0x0
 */
SEDI_RBF_DEFINE(PMU, CDCCLKREQSYNCOFFHOLDOFF_REG, CDC1_BRSBCLK_REQ_SYNCOFF_HOLD_OFF_REG, 4, 4, RW,
		(uint32_t)0x0);
 ...
 *     ResetValue: (uint32_t)0x0
 */
SEDI_RBF_DEFINE(PMU, CDCCLKREQSYNCOFFHOLDOFF_REG, CDC2_SBEPCLK_REQ_SYNCOFF_HOLD_OFF_REG, 8, 4, RW,
		(uint32_t)0x0);
 ...
 *     ResetValue: (uint32_t)0x0
 */
SEDI_RBF_DEFINE(PMU, CDCCLKREQSYNCOFFHOLDOFF_REG, CDC3_FUNCCLK_REQ_SYNCOFF_HOLD_OFF_REG, 12, 4, RW,
		(uint32_t)0x0);
 ...
 *     ResetValue: (uint32_t)0x0
 */
SEDI_RBF_DEFINE(PMU, CDCCLKREQSYNCOFFHOLDOFF_REG, CDC5_MIACCLK_REQ_SYNCOFF_HOLD_OFF_REG, 16, 4, RW,
		(uint32_t)0x0);
 ...
 *     ResetValue: (uint32_t)0x0
 */
SEDI_RBF_DEFINE(PMU, CDCCLKREQSYNCOFFHOLDOFF_REG, CDC6_XTALCLK_REQ_SYNCOFF_HOLD_OFF_REG, 20, 4, RW,
		(uint32_t)0x0);
 ...
 *     ResetValue: (uint32_t)0x0
 */
SEDI_RBF_DEFINE(PMU, CDCCLKREQSYNCOFFHOLDOFF_REG, RSVD_CDCCLKREQSYNCOFFHOLDOFF, 24, 8, RO,
		(uint32_t)0x0);
 ...
 *     ResetValue: (uint32_t)0x0
 */
SEDI_RBF_DEFINE(PMU, ADR_SRAM_PG_FSM_OVERRIDE_EN, RSVD_SRAM_PG_FSM_OVERRIDE_EN, 1, 31, RO,
		(uint32_t)0x0);
